export const linkedin = "https://www.linkedin.com/in/misha-tuyet-nhi-lam-36a369324/";
export const email = "misha080708@gmail.com";
export const name = "Misha Tuyet Nhi Lam"
export const birthday = "2008-08-07"
export const image = "./me.png";
export const projects = [
    {
        id: 1,
        name: "Reklameplakat for Vikingskibsmuseet",
        description: "Det her er fra et skoleprojekt i samarbejde med en norsk skole, hvor vi havde om vikinger. De kom hen og besøgte os og vi blev delt op i grupper. I min gruppe stod jeg for mediegrafikerdelen og jeg skulle lave en plakat. Den første dag var vi henne og se vikingeskibsmuseet i Roskilde og det var også det plakaten skulle være om. Den er ret varm i det og jeg fik også eksperimenteret. Det tog mig to lektioner og den var lavet i Illustrator. - Oktober 2024  ",
        image: "./projects/viking poster.webp",
        link: ""
    },
    {
        id: 2,
        name: "Min første plakat i Illustrator",
        description: "Det her er min første plakat lavet i Illustrator. Jeg har taget inspiration fra KPOP-pigegruppen LE SSERAFIM’s koncept til deres Første Studio Album ‘Unforgiven’. Til det album sagde de linjen: “Do you want to be forgiven?” og den brugte jeg så også. Jeg ville have at det skulle give ‘Fallen Angel’ vibes og selve plakaten er ret mørk. Det tog mig nok to hele dage og som sagt er den lavet i Illustrator. – August 2024 ",
        image: "./projects/kazuha plakat.webp",
        link: ""
    },
    {
        id: 3,
        name: "Plakat af en Filmtrailer til Skoleprojekt",
        description: "Det her er fra et andet skoleprojekt, hvor vi skulle lave vores egen trailer. Mig og min gruppe valgte at vi ville lave en animationstrailer. Udover at jeg stod for at klippe det hele sammen og selve alt videoredigeringen, så har jeg også lavet en plakat til traileren. Kaninen er tegnet af en anden i min gruppe og jeg satte egentligt bare tekst, logo og overskrift på. Det tog mig en dag og den er lavet i Illustrator. - September 2024 ",
        image: "./projects/plakat ace studios.webp",
        link: ""
    },
    {
        id: 4,
